...
.
├── README.md                  ← This file
├── deser_verify.py            ← Part D working script
├── config.json                ← Sample input config
├── Challenge4_Submission.pdf  ← Full written submission
...
*Challenge 4 — Security Automation Remediation Verification | FIND-0139*
